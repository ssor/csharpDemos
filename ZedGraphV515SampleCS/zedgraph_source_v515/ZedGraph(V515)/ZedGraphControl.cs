...
*/
	...
	#region Constructors
		...
		public ZedGraphControl()
		{
            ...
            string titleStr = "±êÌâ";// _resourceManager.GetString("title_def");
            string xStr = "X Öá";// _resourceManager.GetString("x_title_def");
            string yStr = "Y Öá";// _resourceManager.GetString("y_title_def");
