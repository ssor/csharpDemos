    ...
    public class Barcode: IDisposable
    {
        ...
        internal Image Encode()
        {
            ...
            switch (this.Encoded_Type)
            {
                ...
                default: throw new Exception("不支持该编码类型");
        ...
        private Bitmap Generate_Image()
        {
            ...
            if (Encoded_Value == "") throw new Exception("必须首先进行编码！");
            Bitmap b = null;
        ...
        private Image Label_ITF14(Image img)
        {
            ...
            {
                throw new Exception("您触发了异常错误： " + ex.Message);
        ...
        {
            if (EncodedValue == "")
                throw new Exception("无法获取XML，必须首先进行编码！");
