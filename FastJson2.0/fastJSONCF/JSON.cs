...
namespace fastJSON
{
    ...
    public class JSON
    {
        ...
        public object ToObjectListDic(string json)
        {
            object o = new JsonParser(json).Decode();
            return o;
        }
        public IList ToObjectList(string json, Type pt, Type bt)
        {
            object o = new JsonParser(json).Decode();

            return (IList)this.CreateGenericList((ArrayList)o, pt, bt, null);
        }
        public object ToObject(string json, Type type)
        {
            object o = new JsonParser(json).Decode();

            Dictionary<string, object> ht = o as Dictionary<string, object>;
            return ht;
        ...
        private object CreateStringKeyDictionary(Dictionary<string, object> reader, Type pt, Type[] types, Dictionary<string, object> globalTypes)
        {
            ...
            var col = (IDictionary)Activator.CreateInstance(pt);
            Type t1 = null;
            Type t2 = null;
            if (types != null)
            {
